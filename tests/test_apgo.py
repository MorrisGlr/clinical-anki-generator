"""Tests for the APGO HTML parser (src/app_apgo.py).

All tests use a synthetic HTML fixture — no API calls are made.
"""
from pathlib import Path

from src.app_apgo import extract_text_from_html, format_for_anki
...
def test_correct_answer_contains_expected_text():
    ...
    assert "IV fluid resuscitation" in correct_answer_str
